...
const OpenMap = (props) => {
  return(
    <View style={styles.openMap}>
      <View style={styles.firstWrapper}>
        <View style={styles.iconWrapper}>
          <Image
            source={require('../assets/logo/iconlove.png')}
            style={styles.iconStyle}/>
        </View>
        <View>
          <Text style={styles.title}>Find People With Map</Text>
          <Text style={styles.description}>Find your mates on our map. With radar</Text>
          <Text style={styles.description}>geotagging location and more features.</Text>
        </View>
      </View>
      ...
      <View style={styles.secondWrapper}>
        ...
        <TouchableOpacity style={styles.buttonOpenMap}>
          <Text style={styles.buttonOpenMapText}>Open Map</Text>
        </TouchableOpacity>
      </View>
    </View>
  )
